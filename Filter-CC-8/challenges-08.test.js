...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  return arr.filter( n => n.match(/a|e|i|o|u/g))
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  return arr.filter( n => !(n === forbiddenValues))
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return minBaseStat.baseStat.filter( n => !(n > arr));
//   let results = [];
//   if (minBaseStat.filter( arr => (arr > minBaseStat.baseStat))) {
//       results.push(arr);
//   }
//   return results;
};
